...
class Test(unittest.TestCase):
    ...
    def test_size_of_inputs(self):
        ...
        np.testing.assert_array_equal(len(self.input_base), len( gridpp.calc_gradient(self.input_base, self.input_values, gridpp.MinMax, 3)))
    ...
    def test_gradient(self):
        ...
        self.input_values = [[10,10,12,14], [10,12,14,16],[12,14,16,18],[14,16,18,20]]
        output = gridpp.calc_gradient(self.input_base, self.input_values, gridpp.MinMax, 3)
    ...
    def test_nan_input(self):
        ...
        np.testing.assert_array_almost_equal(gridpp.calc_gradient(input_base,self.input_values,
            gridpp.MinMax, 3, 0, 0, default_gradient), default_gradient * np.ones(np.array(self.input_values).shape))
    ...
    def test_non_changing_base(self):
        ...
        default_gradient = -1
        output = gridpp.calc_gradient(self.input_base, self.input_values, gridpp.MinMax, 3, 0, 0, default_gradient)
    ...
    def test_zero_halfwidth(self):
        with self.assertRaises(ValueError) as e:
            gridpp.calc_gradient(self.input_base, self.input_values, gridpp.MinMax, 0, 1)
